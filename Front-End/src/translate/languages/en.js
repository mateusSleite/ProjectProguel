const messages = {
  en: {
    translations: {
      ...
      home: {
        phrase:
          "PROGRAMMING CHALLENGES FIND INNOVATIVE SOLUTIONS. IF YOU'RE STRUGGLING WITH A STUBBORN BUG, ​​NEED HELP OPTIMIZING YOUR CODE, OR ARE LOOKING FOR A CUSTOM SOLUTION FOR A COMPLEX PROJECT. WE CONNECT YOU DIRECTLY WITH EXPERIENCED PROGRAMMERS READY TO SOLVE ANY PROGRAMMING PROBLEM YOU MAY HAVE. WHETHER IT'S A SIMPLE ADJUSTMENT OR THE DEVELOPMENT OF AN ENTIRE FEATURE, OUR TALENT COMMUNITY IS HERE TO HELP",
        stage: "HOW IT WORKS?",
        title1: "POSTING",
        title2: "OF",
        title3: "PROBLEM",
        process:
          "A PRIVATE CHAT CHANNEL IS OPENED BETWEEN THE CUSTOMER AND THE PROGRAMMER TO DISCUSS ADDITIONAL DETAILS, INCLUDING PAYMENT, DEADLINES, AND SPECIFIC DELIVERIES",
        title4: "DELIVERY ",
        title5: "AND ",
        title6: "PAYMENT",
        process2:
          "THE CUSTOMER DESCRIBES THE PROGRAMMING PROBLEM, INCLUDING TECHNICAL DETAILS, SPECIFIC REQUIREMENTS, AND DESIRED TIME FRAME",
        title7: "COMMUNICATION",
        title8: "DEVELOPMENT",
        process3:
          "THE PROGRAMMER SENDS THE COMPLETED SOLUTION THROUGH THE PLATFORM, ONCE THE SOLUTION IS ACCEPTED, PAYMENT IS RELEASED TO THE PROGRAMMER.",
      ...
      details: {
        value: "VALUE",
        language: "LANGUAGE",
        difficultty: "DIFFICULTY",
        resolveProblem: "WANT TO SOLVE THIS PROBLEM?",
        chat: "CHAT",
      },
    },
  },
